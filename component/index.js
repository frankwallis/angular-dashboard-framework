...
angular.module('adf')
    .run([ "$templateCache", function ($templateCache) {
        ...
        $templateCache.put("../src/templates/foundation/dashboard-edit.html", require("../src/templates/foundation/dashboard-edit.html"))
        $templateCache.put("../src/templates/foundation/dashboard.html", require("../src/templates/foundation/dashboard.html"))
        $templateCache.put("../src/templates/foundation/widget-add.html", require("../src/templates/foundation/widget-add.html"))
        $templateCache.put("../src/templates/foundation/widget-edit.html", require("../src/templates/foundation/widget-edit.html"))
        $templateCache.put("../src/templates/foundation/widget.html", require("../src/templates/foundation/widget.html"))
    }]);
